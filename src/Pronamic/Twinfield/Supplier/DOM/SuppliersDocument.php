...
/**
 * The Document Holder for making new XML suppliers. Is a child class
...
class SuppliersDocument extends \DOMDocument
{
    ...
    {
        // Elements and their associated methods for supplier
        $supplierTags = array(
            'code'      => 'getCode',
            'name'      => 'getName',
            'type'      => 'getType',
        ...
        // Go through each supplier element and use the assigned method
